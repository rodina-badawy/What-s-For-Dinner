var recipes = [
  // Lasagna Bolognese
  {
    ...
    cookTime: 90,
    servings: 4,
    imgUrl: "./images/photo-1574894709920-11b28e7367e3.jfif",
  ...
  //   Margherita Pizza
  {
    ...
    cookTime: 12,
    servings: 2,
    imgUrl: "./images/photo-1574071318508-1cdbab80d002.jfif",
    diffeculty: "Intermediate",
    cusine: "Italian",
    longPrep: true,
  ...
  //  Caesar Salad
  {
    ...
    cookTime: 0,
    servings: 2,
    imgUrl: "./images/photo-1546793665-c74683f339c1.jfif",
    diffeculty: "Easy",
  ...
  //  Pad Thai
  {
    ...
    cookTime: 15,
    servings: 2,
    imgUrl: "./images/photo-1559314809-0d155014e29e.jfif",
    diffeculty: "Intermediate",
    cusine: "Asian",
    name: "Pad Thai",
  ...
  //  Chicken Tikka Masala
  {
    ...
    cookTime: 30,
    servings: 4,
    imgUrl: "./images/photo-1565557623262-b51c2513a641.jfif",
    diffeculty: "Intermediate",
    cusine: "Asian",
  ...
  //  Caprese Sandwich
  {
    ...
    cookTime: 5,
    servings: 2,
    imgUrl: "./images/photo-1509722747041-616f39b57569.jfif",
    diffeculty: "Easy",
    cusine: "Italian",
  ...
  //  Creamy Spaghetti Carbonara
  {
    ...
    cookTime: 20,
    servings: 4,
    imgUrl: "./images/photo-1612874742237-6526221588e3.jfif",
    diffeculty: "Easy",
    cusine: "Italian",
  ...
  //  Classic Beef Burger
  {
    ...
    cookTime: 20,
    servings: 4,
    imgUrl: "./images/photo-1568901346375-23c9450c58cd.jfif",
    diffeculty: "Easy",
    cusine: "Asian",
  ...
  //  Vegetable Curry
  {
    ...
    cookTime: 30,
    servings: 4,
    imgUrl: "./images/photo-1585032226651-759b368d7246.jfif",
    diffeculty: "Easy",
    cusine: "Asian",
  ...
  //  French Onion Soup
  {
    ...
    cookTime: 60,
    servings: 4,
    imgUrl: "./images/photo-1547592166-23ac45744acd.jfif",
    diffeculty: "Intermediate",
    cusine: "Mediterranean",
  ...
  //  Greek Moussaka
  {
    ...
    cookTime: 60,
    servings: 4,
    imgUrl: "./images/photo-1601050690597-df0568f70950.jfif",
    diffeculty: "Intermediate",
    cusine: "Mediterranean",
    name: "Greek Moussaka",
    ...
    instructions: [
      "Slice eggplant, salt them, and let sit for 30 minutes. Rinse and pat dry.",
  ...
  //  Shrimp Scampi
  {
    ...
    cookTime: 15,
    servings: 2,
    imgUrl: "./images/photo-1633504581786-316c8002b1b9.jfif",
    diffeculty: "Easy",
    cusine: "SeaFood",
    name: "Shrimp Scampi",
  ...
  //  Mediterranean Quinoa Bowl
  {
    ...
    cookTime: 35,
    servings: 2,
    imgUrl: "./images/photo-1546069901-ba9599a7e63c.jfif",
    diffeculty: "Easy",
    cusine: "Mediterranean",
  ...
  //  Teriyaki Chicken Bowl
  {
    ...
    cookTime: 20,
    servings: 2,
    imgUrl: "./images/photo-1546069901-eacef0df6022.jfif",
    diffeculty: "Easy",
    cusine: "Asian",
  ...
  //  BBQ Pulled Pork
  {
    ...
    cookTime: 240,
    servings: 4,
    imgUrl: "./images/photo-1529692236671-f1f6cf9683ba.jfif",
    diffeculty: "Easy",
    cusine: "American",
  ...
  //  Beef Tacos
  {
    ...
    cookTime: 20,
    servings: 4,
    imgUrl: "./images/photo-1565299585323-38d6b0865b47.jfif",
    diffeculty: "Easy",
    cusine: "American",
    name: "Beef Tacos",
  ...
  //  Chicken Stir-Fry
  {
    ...
    cookTime: 15,
    servings: 4,
    imgUrl: "./images/photo-1603133872878-684f208fb84b.jfif",
    diffeculty: "Easy",
    cusine: "Asian",
  ...
  //  Honey Garlic Salmon
  {
    ...
    cookTime: 15,
    servings: 2,
    imgUrl: "./images/photo-1467003909585-2f8a72700288.jfif",
    diffeculty: "Easy",
    cusine: "Seefood",
  ...
  //  Thai Green Curry
  {
    ...
    cookTime: 25,
    servings: 4,
    imgUrl: "./images/photo-1455619452474-d2be8b1e70cd.jfif",
    diffeculty: "Intermediate",
    cusine: "Asian",
...
function changeRecipe() {
  ...
  var alertdiv = ``;
  if (recipe.longPrep == true) {
    alertdiv = `<div class="prep-time d-flex align-items-center p-3 mb-4 gap-2">
  ...
  document.getElementById("main-meal").innerHTML = `
                ...
                <div class="row">
                  <div class="col-4">
                    ...
                    >
                      ...
                      <p class="m-0">Prep Time</p>
                      <span class="fw-bold">${recipe.prepTime} min</span>
                    </div>
                  </div>
                  <div class="col-4">
                    <div
                    ...
                    >
                      ...
                      <p class="m-0">Cook Time</p>
                      <span class="fw-bold">${recipe.cookTime} min</span>
                    </div>
                  </div>
                  <div class="col-4">
                    <div
                    ...
                    >
                      ...
                      <p class="m-0">Servings</p>
                      <span class="fw-bold">${recipe.servings} people</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-7 p-0">
            <div class="content p-3 bg-white">
              <div class="d-flex gap-2">
                ...
                <span class="country py-1 px-2 rounded-pill">
                  ${recipe.cusine}
                </span>
              </div>
              ...
              <p class="mb-4">${recipe.description}
              </p>
              ${alertdiv}
              ...
              <div class="tab-content" id="pills-tabContent">
                <div
                  ...
                  tabindex="0"
                >
                  <div class="ingrediants-tab p-4">
                  ${recipe.ingrediants
                    .map(
                      (item, index) => `<div class="d-flex gap-2">
                      <span
                        class="number d-flex justify-content-center rounded-circle text-white fw-bold align-items-center"
                      >
                       ${index + 1}
                      </span>
                      <p class="ingredient ms-1 mb-0">${item}</p>
                    </div>`,
                    )
                    .join("")}
                ...
                >
                  ...
                  ${recipe.instructions
                    .map(
                      ...
                      <span
                        class="number d-flex justify-content-center text-white fw-bold align-items-center"
                      >
                        ${index + 1}
                      </span>
                      <p class="instruction ms-1 mb-0">${item}</p>
                    </div>`,
                    )
                    .join("")}
                  ...
                  <div class="nutrition-tab">
                    <div class="container-fluid">
                      <div class="row g-4">
                        <div class="col-md-6">
                          <div
                            class="nutrition calories d-flex align-items-center gap-2 p-3"
                          >
                            <span
                            ...
                            <span class="type me-auto fw-medium">Calories</span>
                            <span class="fw-bold">${recipe.nutrition.Calories} kcal</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div
                            class="nutrition protein d-flex align-items-center gap-2 p-3"
                          >
                            <span
                              class="icon d-flex justify-content-center align-items-center"
                            >
                            ...
                            <span class="type me-auto fw-medium">Protein</span>
                            <span class="fw-bold">${recipe.nutrition.Protein}g</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div
                            class="nutrition carbohydrates d-flex align-items-center gap-2 p-3"
                          >
                            <span
                              class="icon d-flex justify-content-center align-items-center"
                            >
                            ...
                            <span class="type me-auto fw-medium"
                              >Carbohydrates</span
                            >
                            <span class="fw-bold">${recipe.nutrition.Carbohydrates}g</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div
                            class="nutrition fats d-flex align-items-center gap-2 p-3"
                          >
                            <span
                              class="icon d-flex justify-content-center align-items-center"
                            >
                            ...
                            <span class="type me-auto fw-medium">Fats</span>
                            <span class="fw-bold">${recipe.nutrition.Fat}g</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div
                            class="nutrition fiber d-flex align-items-center gap-2 p-3"
                          >
                            <span
                              class="icon d-flex justify-content-center align-items-center"
                            >
                            ...
                            <span class="type me-auto fw-medium">Fiber</span>
                            <span class="fw-bold">${recipe.nutrition.Fiber}g</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div
                            class="nutrition sodium d-flex align-items-center gap-2 p-3"
                          >
                            <span
                              class="icon d-flex justify-content-center align-items-center"
                            >
                            ...
                            <span class="type me-auto fw-medium">Sodium</span>
                            <span class="fw-bold">${recipe.nutrition.Sodium}mg</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                >
                  ...
                  ${recipe.tips
                    .map(
                      (item, index) => `
                    <div class="tip d-flex gap-2 p-3  mb-3 align-items-center">
                      <span >
                        <i class="fas fa-circle-check"></i>
                      </span>
                      <p class="tip m-0">${item}</p>
                    </div>
                    `,
                    )
                    .join("")}
              ...
              <div class="pt-3 mt-4 btn-toggel">
                <button class="px-4 border-0 text-white" onclick="changeRecipe()">
